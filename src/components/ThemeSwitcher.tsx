...
import { useTheme, colorThemes, type ColorTheme } from "./ThemeProvider";
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 z-50 bg-popover border border-border rounded-xl shadow-lg p-3 min-w-[180px]"
          >
